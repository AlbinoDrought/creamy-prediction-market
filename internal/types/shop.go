...
var AllShopItems = []ShopItem{
	...
	// Titles - Betting
	{ID: "title_broke", Category: ShopItemCategoryTitle, Name: "Broke", Price: 1, Icon: "💸", Value: "Broke"},
	{ID: "title_gambler", Category: ShopItemCategoryTitle, Name: "Gambler", Price: 5, Icon: "🎲", Value: "Gambler"},
	{ID: "title_all_in", Category: ShopItemCategoryTitle, Name: "All In", Price: 10, Icon: "♠️", Value: "All In"},
	{ID: "title_high_roller", Category: ShopItemCategoryTitle, Name: "High Roller", Price: 10, Icon: "🎰", Value: "High Roller"},
	{ID: "title_degen", Category: ShopItemCategoryTitle, Name: "Degen", Price: 10, Icon: "😈", Value: "Degen"},
	{ID: "title_oracle", Category: ShopItemCategoryTitle, Name: "Oracle", Price: 15, Icon: "🔮", Value: "Oracle"},
	{ID: "title_whale", Category: ShopItemCategoryTitle, Name: "Whale", Price: 20, Icon: "🐋", Value: "Whale"},
	{ID: "title_prophet", Category: ShopItemCategoryTitle, Name: "Prophet", Price: 25, Icon: "🌟", Value: "Prophet"},

	// Titles - Tech
	{ID: "title_10x_engineer", Category: ShopItemCategoryTitle, Name: "10x Engineer", Price: 10, Icon: "⚡", Value: "10x Engineer"},
	{ID: "title_senior_intern", Category: ShopItemCategoryTitle, Name: "Senior Intern", Price: 5, Icon: "📎", Value: "Senior Intern"},
	{ID: "title_stack_overflow", Category: ShopItemCategoryTitle, Name: "Stack Overflow Survivor", Price: 10, Icon: "📚", Value: "Stack Overflow Survivor"},
	{ID: "title_yaml_engineer", Category: ShopItemCategoryTitle, Name: "YAML Engineer", Price: 10, Icon: "📝", Value: "YAML Engineer"},
	{ID: "title_git_blame", Category: ShopItemCategoryTitle, Name: "git blame Enthusiast", Price: 10, Icon: "🔍", Value: "git blame Enthusiast"},
	{ID: "title_lgtm", Category: ShopItemCategoryTitle, Name: "LGTM", Price: 5, Icon: "👍", Value: "LGTM"},
	{ID: "title_it_works_locally", Category: ShopItemCategoryTitle, Name: "Works On My Machine", Price: 10, Icon: "🤷", Value: "Works On My Machine"},
	{ID: "title_refactorer", Category: ShopItemCategoryTitle, Name: "Compulsive Refactorer", Price: 15, Icon: "♻️", Value: "Compulsive Refactorer"},
	{ID: "title_rubber_duck", Category: ShopItemCategoryTitle, Name: "Rubber Duck", Price: 5, Icon: "🦆", Value: "Rubber Duck"},
	{ID: "title_prompt_engineer", Category: ShopItemCategoryTitle, Name: "Prompt Engineer", Price: 15, Icon: "🤖", Value: "Prompt Engineer"},
	{ID: "title_undefined", Category: ShopItemCategoryTitle, Name: "undefined", Price: 10, Icon: "❓", Value: "undefined"},
	{ID: "title_404", Category: ShopItemCategoryTitle, Name: "404 Not Found", Price: 10, Icon: "🚫", Value: "404 Not Found"},

	// Titles - Enterprise / Product
	{ID: "title_synergy", Category: ShopItemCategoryTitle, Name: "Synergy Specialist", Price: 10, Icon: "🤝", Value: "Synergy Specialist"},
	{ID: "title_thought_leader", Category: ShopItemCategoryTitle, Name: "Thought Leader", Price: 15, Icon: "🧠", Value: "Thought Leader"},
	{ID: "title_disruptor", Category: ShopItemCategoryTitle, Name: "Disruptor", Price: 15, Icon: "💥", Value: "Disruptor"},
	{ID: "title_stakeholder", Category: ShopItemCategoryTitle, Name: "Key Stakeholder", Price: 10, Icon: "🔑", Value: "Key Stakeholder"},
	{ID: "title_blocker", Category: ShopItemCategoryTitle, Name: "Blocker", Price: 5, Icon: "🚧", Value: "Blocker"},
	{ID: "title_circle_back", Category: ShopItemCategoryTitle, Name: "Let's Circle Back", Price: 10, Icon: "🔄", Value: "Let's Circle Back"},
	{ID: "title_per_my_email", Category: ShopItemCategoryTitle, Name: "Per My Last Email", Price: 15, Icon: "📧", Value: "Per My Last Email"},
	{ID: "title_vc_funded", Category: ShopItemCategoryTitle, Name: "VC Funded", Price: 20, Icon: "💰", Value: "VC Funded"},

	// Titles - Drinking
	{ID: "title_drunk", Category: ShopItemCategoryTitle, Name: "Drunk", Price: 5, Icon: "🍺", Value: "Drunk"},
	{ID: "title_sommelier", Category: ShopItemCategoryTitle, Name: "Sommelier", Price: 15, Icon: "🍷", Value: "Sommelier"},
	{ID: "title_designated_drinker", Category: ShopItemCategoryTitle, Name: "Designated Drinker", Price: 10, Icon: "🍻", Value: "Designated Drinker"},
	{ID: "title_on_the_rocks", Category: ShopItemCategoryTitle, Name: "On The Rocks", Price: 10, Icon: "🥃", Value: "On The Rocks"},
	{ID: "title_bottomless_mimosas", Category: ShopItemCategoryTitle, Name: "Bottomless Mimosas", Price: 15, Icon: "🥂", Value: "Bottomless Mimosas"},
	{ID: "title_happy_hour", Category: ShopItemCategoryTitle, Name: "Happy Hour", Price: 5, Icon: "🍹", Value: "Happy Hour"},
	{ID: "title_liquid_courage", Category: ShopItemCategoryTitle, Name: "Liquid Courage", Price: 10, Icon: "🫡", Value: "Liquid Courage"},
	{ID: "title_beer_goggles", Category: ShopItemCategoryTitle, Name: "Beer Goggles", Price: 10, Icon: "🥴", Value: "Beer Goggles"},

	// Titles - Goofy
	{ID: "title_gremlin", Category: ShopItemCategoryTitle, Name: "Gremlin", Price: 5, Icon: "👹", Value: "Gremlin"},
	{ID: "title_chaos_agent", Category: ShopItemCategoryTitle, Name: "Chaos Agent", Price: 15, Icon: "🌀", Value: "Chaos Agent"},
	{ID: "title_npc", Category: ShopItemCategoryTitle, Name: "NPC", Price: 5, Icon: "🗿", Value: "NPC"},
	{ID: "title_main_character", Category: ShopItemCategoryTitle, Name: "Main Character", Price: 20, Icon: "⭐", Value: "Main Character"},
	{ID: "title_touch_grass", Category: ShopItemCategoryTitle, Name: "Needs To Touch Grass", Price: 10, Icon: "🌱", Value: "Needs To Touch Grass"},
	{ID: "title_lurker", Category: ShopItemCategoryTitle, Name: "Lurker", Price: 5, Icon: "👀", Value: "Lurker"},
